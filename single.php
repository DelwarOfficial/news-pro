							...
							<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
								<div class="single-card-container grid-card">
									<div class="single-card-image">
										<a href="<?php the_permalink(); ?>"><?php news_record_post_thumbnail(); ?></a>
									</div>
									<div class="single-card-detail">
										...
										<div class="post-exerpt">
											<p><?php echo wp_kses_post( wp_trim_words( get_the_excerpt(), get_theme_mod( 'news_record_excerpt_length', 15 ) ) ); ?></p>
										</div><!-- post-exerpt -->
									</div>
								</div>
							</article>
