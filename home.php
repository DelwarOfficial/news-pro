...
get_header();
$archive_page_title = get_theme_mod( 'news_record_archive_page_title', '' );
?>
...
<main id="primary" class="site-main">
	...
	if ( is_front_page() && is_home() ) :
		// Include frontpage sections (banner + others) when latest posts are shown on front.
	...
	<?php if ( have_posts() ) : ?>
		...
		<?php if ( news_record_is_frontpage_blog() ) { ?>
		...
		$col_layout = get_theme_mod( 'news_record_archive_column_layout', 'double-column' );
		?>
