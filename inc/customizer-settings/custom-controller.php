 ...
 */
class News_Record_Toggle_Checkbox_Custom_control extends WP_Customize_Control {
	/**
 ...
 */
class News_Record_Customize_Horizontal_Line extends WP_Customize_Control {
	/**
	 * Control Type
	 */
	public $type = 'hr';
...
class News_Record_Section_Sub_Heading_Control extends WP_Customize_Control {
 ...
 * Multi Input field
 */
class News_Record_Multi_Input_Custom_control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label class="customize_multi_input">
			...
			<a href="#" class="button button-primary customize_multi_add_field"><?php esc_html_e( 'Add More', 'news-record' ); ?></a>
		</label>
		<?php
	}
}
