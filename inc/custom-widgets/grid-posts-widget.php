<?php
if ( ! class_exists( 'News_Record_Grid_Posts_Widget' ) ) {
	/**
	 * Adds News Record Grid Widget.
	 */
	class News_Record_Grid_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$grid_posts_widget = array(
				'classname'   => 'news-record-widget grid-posts-widget',
				'description' => __( 'Retrive Grid Widgets', 'news-record' ),
			);
			parent::__construct(
				'news_record_grid_posts_widget',
				__( 'Artify Widget: Grid Widget', 'news-record' ),
				$grid_posts_widget
			);
		}
