<?php
if ( ! class_exists( 'News_Record_Grid_List_Posts_Widget' ) ) {
	/**
	 * Adds News Record Grid List Widget.
	 */
	class News_Record_Grid_List_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$grid_list_widget = array(
				'classname'   => 'news-record-widget grid-list-posts-widget',
				'description' => __( 'Retrive Grid List Widgets', 'news-record' ),
			);
			parent::__construct(
				'news_record_grid_list_posts_widget',
				__( 'Artify Widget: Grid List Widget', 'news-record' ),
				$grid_list_widget
			);
		}
