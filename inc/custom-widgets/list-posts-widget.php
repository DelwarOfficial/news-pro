<?php
if ( ! class_exists( 'News_Record_List_Posts_Widget' ) ) {
	/**
	 * Adds News Record List Widget.
	 */
	class News_Record_List_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$list_widget = array(
				'classname'   => 'news-record-widget list-posts-widget',
				'description' => __( 'Retrive List Widgets', 'news-record' ),
			);
			parent::__construct(
				'news_record_list_posts_widget',
				__( 'Artify Widget: List Widget', 'news-record' ),
				$list_widget
			);
		}
