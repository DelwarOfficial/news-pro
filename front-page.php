...
if ( news_record_is_latest_posts() ) {

	require get_home_template();

} elseif ( news_record_is_frontpage() ) {

	require get_template_directory() . '/inc/frontpage-sections/sections.php';

}

if ( get_theme_mod( 'news_record_enable_frontpage_content', false ) === true && 'page' === get_option( 'show_on_front' ) ) {
	?>
